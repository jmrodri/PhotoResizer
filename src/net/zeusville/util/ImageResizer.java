...
public class ImageResizer
{
  ...
  {
      if( srcImgName == null || dstImgName == null )
          return;
   ...
   */
  public static BufferedImage scale(BufferedImage srcImg,
   ...
   * @return resized image
   */
  public static BufferedImage resize(BufferedImage srcImg,
								   int dstW, int dstH)
  {
	// get image dimensions
	int srcW = srcImg.getWidth();
  ...
  public static void main(String[] argv)
  {
	if (argv.length == 5) {
	  ...
	  ImageResizer.scaleImage(argv[0], argv[1],
	  		scaleX, scaleY,
	  		argv[4]);
	}
	else {
